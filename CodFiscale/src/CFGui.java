/*
  * Descrizione: Crea la Gui e lancia l'applicazione CFGenerator
  *
...
class CFGui extends JFrame {
  ...
  CFGui() {
    super("Generatore di Codici Fiscali | (c) Marco 'RootkitNeo' | License: GNU/GPL v.3");
    ...
    JLabel descrizione = new JLabel("La seguente applicazione permette, dopo aver inserito i dati richiesti in input, di ottenere il proprio "+
                                    "codice fiscale.");
